...
| Слой        | Технология                                     |
| ----------- | ---------------------------------------------- |
| Framework   | Next.js 16 (App Router, client-only)           |
...
_Под кнопками мелким серым: "это демо — настоящие кнопки откроют ваш мессенджер"_
...
>
> _P.S. Знаете подругу, которой это тоже было бы интересно?_
>
> **[Поделиться в WhatsApp]** **[Скопировать ссылку]**
>
> ---
>
> _Эта страница — демо продукта «Свои»._
