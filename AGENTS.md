...
- **Up to date** → reuse it.
Each digest: pin the version(s) in the header; keep only what matters for *our* stack (Next 16, React 19, Tailwind v4, FSD). Short and project-specific — not a copy of the docs.
